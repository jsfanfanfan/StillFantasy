# StillFantasy 动手自制大模型推理框架，支持LLama2/3和Qwen2.5
...
## 生成文本的方法
```shell
./still_fantasy llama2_7b.bin tokenizer.model
...
- 运行：
```shell
./build/demo/still_fantasy Llama-3.2-1B.bin meta-llama/Llama-3.2-1B/tokenizer.json
