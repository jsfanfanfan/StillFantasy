#ifndef STILLFANTASY_INCLUDE_BASE_BASE_H_
#define STILLFANTASY_INCLUDE_BASE_BASE_H_
...
inline size_t DataTypeSize(DataType data_type) {
  ...
  } else if (data_type == DataType::kDataTypeFp16 || data_type == DataType::kDataTypeBf16) {
    return 2;
  } else {
    return 0;
  }
...
#endif  // STILLFANTASY_INCLUDE_BASE_BASE_H_
